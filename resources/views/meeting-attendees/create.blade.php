    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-slate-800 shadow-md rounded-lg p-6">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Add Meeting Attendee</h1>
                ...
                <form action="{{ route('meeting-attendees.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="meeting_detail_id" id="meeting_detail_id" required
                            ...
                            @foreach($meetings as $meeting)
                                <option value="{{ $meeting->id }}" {{ old('meeting_detail_id') == $meeting->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-6">
                        ...
                        <select name="attendee_id" id="attendee_id" required
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('attendee_id') == $user->id ? 'selected' : '' }}>
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fas fa-save mr-2"></i>Add Attendee
                        </button>
                    </div>
                </form>
            </div>
