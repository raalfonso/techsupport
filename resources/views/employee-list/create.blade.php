            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('employee-list.store') }}" method="POST">
                    ...
                    <div id="inactive-fields" class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" style="display: none;">
                        <div>
                            ...
                            <select name="inactive_reason" id="inactive_reason" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('inactive_reason') border-red-500 @enderror">
                                ...
                                <option value="resigned" {{ old('inactive_reason') === 'resigned' ? 'selected' : '' }}>Resigned</option>
                                <option value="recall" {{ old('inactive_reason') === 'recall' ? 'selected' : '' }}>Recall</option>
                                <option value="terminated" {{ old('inactive_reason') === 'terminated' ? 'selected' : '' }}>Terminated</option>
                                <option value="retired" {{ old('inactive_reason') === 'retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="inactive_date" id="inactive_date" value="{{ old('inactive_date') }}" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('inactive_date') border-red-500 @enderror">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="remarks" rows="4" class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter any additional remarks or notes...">{{ old('remarks') }}</textarea>
