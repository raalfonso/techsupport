...
<nav class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-4 shadow-md top-0 z-50 min-w-full fixed max-h-16">
    <div class="flex items-center justify-between container mx-auto w-full">
        ...
        <div class="hidden md:flex items-center space-x-1">
            <a href="{{ route('keyboard.index') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium {{ request()->routeIs('keyboard.index') ? 'bg-blue-50 dark:bg-slate-700 text-blue-600' : '' }}">
                <i class="material-icons text-lg">view_kanban</i><span>Board</span>
            </a>
            <a href="{{ route('keyboard.calendar') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium {{ request()->routeIs('keyboard.calendar') ? 'bg-blue-50 dark:bg-slate-700 text-blue-600' : '' }}">
                <i class="material-icons text-lg">calendar_month</i><span>Calendar</span>
            </a>
            <a href="{{ route('keyboard.archive') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium {{ request()->routeIs('keyboard.archive') ? 'bg-blue-50 dark:bg-slate-700 text-blue-600' : '' }}">
                <i class="material-icons text-lg">archive</i><span>Archive</span>
            </a>
            <a href="{{ route('keyboard.settings') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium {{ request()->routeIs('keyboard.settings') ? 'bg-blue-50 dark:bg-slate-700 text-blue-600' : '' }}">
                <i class="material-icons text-lg">settings</i><span>Settings</span>
            </a>
