...
<head>
    ...
    <title>Request Approvals - {{ env('APP_NAME', 'IT Department') }}</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-start">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Request Approvals</h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Review and manage personnel request approvals</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-slate-600">
                                @foreach($requestPersonnel as $request)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ $request->requestor->department->name ?? 'N/A' }}
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-center gap-2">
                                                <a href="{{ route('request-personnel.approval-show', $request) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition" title="View & Approve">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-lg">No requests found for approval.</p>
                    </div>
                @endif
            </div>
        </div>
