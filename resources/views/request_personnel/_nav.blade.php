...
<nav class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-4 shadow-md top-0 z-50 min-w-full fixed max-h-16">
    <div class="flex items-center justify-between container mx-auto w-full">
        <div class="text-lg font-bold text-gray-800 dark:text-white flex items-center">
            ...
            BCDA Personnel Request
        </div>

        <div class="hidden md:flex items-center space-x-1">
            <a href="{{ route('request-personnel.index') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium">
                <i class="material-icons text-lg">list</i><span>All Requests</span>
            </a>
            <a href="{{ route('request-personnel.create') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium">
                <i class="material-icons text-lg">add_circle</i><span>New Request</span>
            </a>
            @if($isAdmin)
            <a href="{{ route('request-personnel.approval') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium">
                <i class="material-icons text-lg">approval</i><span>Approvals</span>
            </a>
            <a href="{{ route('resources.index') }}" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-slate-700 hover:text-blue-600 px-3 py-2 rounded-lg transition font-medium">
                <i class="material-icons text-lg">inventory_2</i><span>Resource CMS</span>
            </a>
            @endif
