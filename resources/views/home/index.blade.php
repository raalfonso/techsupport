<x-layout>
    <div class="container mx-auto px-4">
        <div class="flex">
            <!-- Left Column -->
            <div class="w-2/6 max-w-fit">
                <!-- Content for the 3-column width -->
                <img src="{{ asset('images/rb_2148887720.png') }}" alt="Example Image" class="w-[644px] h-[504px]">
            ...
            <div class="w-3/4 ml-20">
                ...
                <div class="flex space-x-4">
                    ...
                    <div class="relative max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 min-w-52">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">AODOCS</h5>
                        </a>
                        <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                            <li>Forgot password</li>
                            <li>Reset password</li>
                ...
                <div class="flex space-x-4 mt-4">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 min-w-52">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Setup</h5>
                        </a>
