...
<head>
    ...
    <title>Absent Today Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="report-info">
            ...
            <div>
                <strong>Total Absent:</strong> {{ count($absentEmployees) }}
            </div>
        </div>
        
        <div class="summary">
            <strong>Summary:</strong> This report shows all active employees who have not clocked in on {{ \Carbon\Carbon::parse($date ?? today())->format('M d, Y') }}.
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" style="text-align: center; color: #999;">All employees are present today</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
