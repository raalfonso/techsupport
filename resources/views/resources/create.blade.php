    ...
    <div class="space-y-6 py-8">
        <div class="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create Resource</h1>
                    <p class="text-gray-600 dark:text-gray-400">Add an item for request-personnel resource selection.</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-6">
                <form action="{{ route('resources.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="item_name" id="item_name" value="{{ old('item_name') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        @error('item_name')
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" value="1" class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500" {{ old('is_active', true) ? 'checked' : '' }}>
                    ...
                    <div class="flex gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
                        ...
                        <button type="submit" class="inline-flex items-center justify-center px-5 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Create Resource</button>
                    </div>
                </form>
            </div>
        </div>
